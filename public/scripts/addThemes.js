let itemsTheme = {
    ...
    footer: {
        ...
        footerInitialTitle: document.getElementById("footer-initial-title"),
        footerIconsList: [
            {
...
const addSetIcons = (footerIcon, firstColor = "footer-section-icon-white", secondCOlor = "footer-section-icon") => {
    const darkIconImages = [
